...
import revvCover from "./assets/covers/revv.png";
import nooluCover from "./assets/covers/noolu.png";
import signalflowCover from "./assets/covers/signal-flow.png";
import quantmworldCover from "./assets/covers/quantmworld.png";
import llCapitalCover from "./assets/covers/ll-capital.png";
import fplBuddyCover from "./assets/covers/fpl-buddy.png";
...
import { BsWhatsapp, BsDiscord, BsTwitterX } from "react-icons/bs";
...
const socialMedia = [
  {
    ...
    name: "twitter",
    icon: <BsTwitterX />,
    link: "https://x.com/messages/compose?recipient_id=843231377264926720",
  },
  {
    id: 2,
    name: "github",
...
const projectsActive = [
  {
    ...
    name: "Ultiverse Demo",
    description:
      "UTILIZING METAFI, UE5, AND WEB3 TECHNOLOGY TO CREATE A SOCIAL AND IMMERSIVE GAMING METAVERSE.",
  ...
  },
  {
    ...
    name: "Artsy",
    description:
      "A photography gallery that serves creators and collectors of art and photography generally. Flip through more than 10,000 vintage shots, old photograghs, historic images and captures seamlessly in one place. Register to get top access.",
  ...
  },
  {
    id: 3,
    name: "Revv",
    description: "Autoshop management system",
    stacks: ["Vuejs", "tailwindcss"],
    coverArt: revvCover,
    projectRepoLink: "",
    projectLiveLink: "https://shop.revvauto.care/",
  },
  {
    id: 6,
    name: "Musica",
  ...
  },
  {
    ...
    coverArt: nooluCover,
    projectRepoLink: "",
    projectLiveLink: "https://www.nooluhq.com/",
  },
  {
    id: 5,
    name: "Signalflow",
    description: "Signal trading platform",
    stacks: ["GO lang", "tailwindcss"],
    coverArt: signalflowCover,
    projectRepoLink: "",
    projectLiveLink: "",
  },
  ...
  },
  {
    ...
    description:
      "Home rental agency website design.The most affortable place to stay in the san franciso bay area.",
    stacks: ["React", "javaScript", "css3", "bootstrap"],
  ...
  },
  {
    id: 12,
    name: "FPL Buddy",
    description: "Fantasy premier league helper app",
    stacks: ["React", "python", "css3", "bootstrap"],
    coverArt: fplBuddyCover,
    projectRepoLink: "https://github.com/Ayo-Osota/fpl-buddy",
    projectLiveLink: "https://fpl-buddy.vercel.app/",
  },
  {
    id: 11,
    name: "LL Capital",
    description: "Solona NFT marketplace",
    stacks: ["React", "javaScript", "css3", "bootstrap"],
    coverArt: llCapitalCover,
    projectRepoLink: "",
    projectLiveLink: "https://ll-capital.vercel.app/",
  },
  {
    id: 9,
    name: "Paw care",
  ...
  },
  {
    id: 10,
    name: "Quantmworld",
    description: "Custom Shopify e-commerce store and non-profit website.",
    stacks: ["Shopify liquid"],
    coverArt: quantmworldCover,
    projectRepoLink: "https://github.com/Ayo-Osota/quantum-world",
    projectLiveLink: "https://quantmworld.com/",
  },
];
...
const testimonials = [
  ...
  },
  {
    ...
    feedback:
      "Ayomikun's attention to detail and expertise in frontend development are truly impressive, and they are always willing to provide valuable insights and recommendations to improve the project's overall performance. Ayomikun is an excellent communicator, and they always keep me updated on the project's progress.",
